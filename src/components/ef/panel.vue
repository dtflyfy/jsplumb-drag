    ...
    export default {
        ...
        methods: {
            ...
            addNode(evt, nodeMenu, mousePosition) {
                ...
                console.log("containerRect:"+containerRect.x)
                console.log("efContainer:"+efContainer.scrollLeft)
                top = top - containerRect.y + efContainer.scrollTop
                console.log("top:"+top)
                console.log("containerRect:"+containerRect.y)
                console.log("efContainer:"+efContainer.scrollTop)
